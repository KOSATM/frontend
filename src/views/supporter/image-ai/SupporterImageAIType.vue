    ...
    <div class="card p-4 mt-3">
      ...
      <ul class="list-unstyled mt-2">
        ...
        <li
          ...
          role="button"
          tabindex="0"
          @keyup.enter.space.prevent="setType('landscape')"
          aria-pressed="false"
        >
        ...
        <li
          ...
          role="button"
          tabindex="0"
          @keyup.enter.space.prevent="setType('food')"
          aria-pressed="false"
        >
        ...
        <li
          class="option-item p-3 mb-2 rounded d-flex align-items-center"
          :class="{ selected: selectedType === 'people' }"
          @click="setType('people')"
          role="button"
          tabindex="0"
          @keyup.enter.space.prevent="setType('people')"
          aria-pressed="false"
        >
...
.option-item:focus { box-shadow: 0 0 0 4px rgba(27,59,111,0.06); }
