  ...
  <div class="modal-backdrop" @click="$emit('close')">
    <div class="modal-card" @click.stop>
      ...
      <p class="small text-muted mb-3">
        Choose a replacement for <strong>{{ target?.title }}</strong>
      </p>
      ...
      <div class="list-group">
        ...
        >
          <div class="d-flex align-items-center gap-3">
            ...
            <button class="btn btn-sm btn-outline-primary rounded-pill" @click.stop="$emit('apply', alt)">Replace</button>
          </div>
        </div>
      </div>
      ...
      <div class="d-flex justify-content-between mt-3">
        ...
        <button class="btn btn-danger" @click="$emit('delete')">Delete anyway</button>
      </div>
    </div>
  </div>
</template>
